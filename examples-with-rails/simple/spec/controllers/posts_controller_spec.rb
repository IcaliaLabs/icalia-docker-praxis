...
RSpec.describe PostsController, type: :controller do
  ...
  describe 'GET #index' do
    let!(:test_post) { create :post, valid_attributes }
    ...
    it 'includes the existing posts into the list' do
      get :index
      expect(assigns(:posts)).to include test_post
    end
  end
  ...
  describe 'PUT #update' do
    ...
    context 'with valid params' do
      ...
      it 'updates the requested post' do
        ...
        }.to change { test_post.reload.title }.to 'Updated Title'
      end
    ...
    context 'with invalid params' do
      ...
      it 'does not update the requested post' do
        expect {
          put :update, params: { id: test_post.to_param, post: invalid_attributes }
        }.not_to change test_post.reload, :title
      end
    end
  end
